      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 dark:border-slate-800 pb-4">
          <div className="flex items-center gap-3">
            <div className="p-2.5 rounded-2xl bg-amber-50 dark:bg-amber-950 text-amber-600 dark:text-amber-400 border border-amber-200 dark:border-amber-800 shrink-0">
              <Video size={20} />
            </div>
            <div>
          ...
          {activeResumeFileName && (
            <div className="px-3.5 py-1.5 rounded-2xl bg-amber-50 dark:bg-amber-950/40 text-amber-700 dark:text-amber-300 text-xs font-bold border border-amber-200 shrink-0">
        ...
        {sessionStep === "setup" && (
          <div className="space-y-6">
            {/* PROPER 3-COLUMN EQUAL-WIDTH RESPONSIVE FORM GRID */}
            ...
            <div className="pt-2 border-t border-slate-100 dark:border-slate-800 space-y-4">
              ...
              <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 grid grid-cols-2 sm:grid-cols-5 gap-3 text-center">
                <div>
                  <span className="text-[10px] font-bold text-slate-400 uppercase block">Questions</span>
                  <span className="text-xs font-black text-slate-900 dark:text-slate-100 block mt-0.5">12 Questions</span>
                </div>
                <div>
                  <span className="text-[10px] font-bold text-slate-400 uppercase block">Estimated Time</span>
                  <span className="text-xs font-black text-amber-600 block mt-0.5">25 Mins</span>
                </div>
                <div>
                  <span className="text-[10px] font-bold text-slate-400 uppercase block">Difficulty</span>
                  <span className="text-xs font-black text-slate-900 dark:text-slate-100 block mt-0.5">{difficulty}</span>
                </div>
                <div>
                  <span className="text-[10px] font-bold text-slate-400 uppercase block">Role Focus</span>
                  <span className="text-xs font-black text-slate-900 dark:text-slate-100 truncate block mt-0.5">{jobTitle}</span>
                </div>
                <div>
                  <span className="text-[10px] font-bold text-slate-400 uppercase block">Round Focus</span>
                  <span className="text-xs font-black text-amber-600 uppercase block mt-0.5">{roundType}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 rounded-2xl bg-amber-50/60 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 space-y-3">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-3">
                  <span className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-900 text-white text-xs font-bold font-mono">
                    <Clock size={13} className="text-amber-400" /> {formatTimer(secondsRemaining)}
                  </span>
            ...
            <div className="p-6 sm:p-8 rounded-3xl bg-slate-900 text-white border border-slate-800 space-y-3 shadow-xl relative overflow-hidden">
              ...
              <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl space-y-5">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
                  <div className="p-3.5 rounded-2xl bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800">
                    <span className="text-[10px] font-bold text-amber-700 dark:text-amber-300 uppercase block">Overall Score</span>
                    <span className="text-2xl font-black text-slate-900 dark:text-slate-100 my-0.5">{evaluation.score ?? evaluation.overallScore}/100</span>
                  </div>

                  <div className="p-3.5 rounded-2xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800">
                    <span className="text-[10px] font-bold text-emerald-700 dark:text-emerald-300 uppercase block">Tech Accuracy</span>
                    <span className="text-2xl font-black text-slate-900 dark:text-slate-100 my-0.5">{evaluation.technicalAccuracyScore ?? evaluation.correctness}%</span>
                  </div>

                  <div className="p-3.5 rounded-2xl bg-indigo-50 dark:bg-indigo-950/40 border border-indigo-200 dark:border-indigo-800">
                    <span className="text-[10px] font-bold text-indigo-700 dark:text-indigo-300 uppercase block">Completeness</span>
                    <span className="text-2xl font-black text-slate-900 dark:text-slate-100 my-0.5">{evaluation.completeness}%</span>
                  </div>

                  <div className="p-3.5 rounded-2xl bg-purple-50 dark:bg-purple-950/40 border border-purple-200 dark:border-purple-800">
                    <span className="text-[10px] font-bold text-purple-700 dark:text-purple-300 uppercase block">Communication</span>
                    <span className="text-2xl font-black text-slate-900 dark:text-slate-100 my-0.5">{evaluation.communicationScore}%</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 rounded-2xl bg-emerald-50/60 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800 space-y-2">
                    <span className="text-xs font-bold text-emerald-900 dark:text-emerald-200 block flex items-center gap-1.5">
                  ...
                  <div className="p-4 rounded-2xl bg-rose-50/60 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-800 space-y-2">
                    <span className="text-xs font-bold text-rose-900 dark:text-rose-200 block flex items-center gap-1.5">
          ...
          <div className="space-y-6 pt-2">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 dark:border-slate-800 pb-3">
              <div>
                ...
                <p className="text-xs text-slate-500">{jobTitle} • {roundType.toUpperCase()} Session Summary ({sessionHistory.length} Questions)</p>
              </div>

              <span className="text-sm font-black px-4 py-1.5 rounded-full bg-amber-600 text-white shadow-md shrink-0">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
              <div className="p-4 rounded-2xl bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800">
                <span className="text-[10px] font-bold text-amber-700 dark:text-amber-300 uppercase block">Overall Score</span>
                <span className="text-3xl font-black text-slate-900 dark:text-slate-100 my-1">{finalReport.overallScore}/100</span>
              </div>

              <div className="p-4 rounded-2xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800">
                <span className="text-[10px] font-bold text-emerald-700 dark:text-emerald-300 uppercase block">Technical Score</span>
                <span className="text-3xl font-black text-slate-900 dark:text-slate-100 my-1">{finalReport.technicalScore}%</span>
              </div>

              <div className="p-4 rounded-2xl bg-indigo-50 dark:bg-indigo-950/40 border border-indigo-200 dark:border-indigo-800">
                <span className="text-[10px] font-bold text-indigo-700 dark:text-indigo-300 uppercase block">Communication</span>
                <span className="text-3xl font-black text-slate-900 dark:text-slate-100 my-1">{finalReport.communicationScore}%</span>
              </div>

              <div className="p-4 rounded-2xl bg-purple-50 dark:bg-purple-950/40 border border-purple-200 dark:border-purple-800">
                <span className="text-[10px] font-bold text-purple-700 dark:text-purple-300 uppercase block">Role Relevance</span>
                <span className="text-3xl font-black text-slate-900 dark:text-slate-100 my-1">{finalReport.roleRelevanceScore || finalReport.accuracyScore}%</span>
              </div>
            </div>
